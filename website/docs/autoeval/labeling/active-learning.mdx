...
[Active learning](https://en.wikipedia.org/wiki/Active_learning_(machine_learning)) is the process of using an algorithm (an LLM in this case) to interactively label the training data. 
...
that accurately reflects your evaluation criteria is critical to [fine-tuning](/autoeval/fine-tune) a high quality evaluator model.